...
theta_add = ws["B19"].value # Additonal coverage value for penetration depth and slope (-)
...
calcvalues_data = {
   ...
   "Value": [L, h, vA, DKn, DA, D, Knudsen, Thiele, ThetaDiff, x_at_theta[0.5], PD50, slopePD50, Backc, pA0*t_pulse]
}
